...
<html>
    ...
    <body>
        ...
        <form id="areaRect" name="areaRect" action="r2r.do" 
            ...
            <%
                ...
                String sRectangleResult = " "; // default message
        ...
        <form id="areaCircle" name="areaCircle" method="post"  
              onsubmit="return myCirleValidator()" action="c2s.do">
            <p>Radius of the Circle: <input type="text" name="radius"><br>
                <input type="submit" name ="submit" value="Area Circle">
            </p>
            <%
                Object arearesult = request.getAttribute("arearesult");
                String sAreaResult = " "; // default message
        ...
        <form id="thirdSide" name="thirdSide" method="post"  
              onsubmit="return myTriangleValidator()" action="hypo.do">
            ...
            <%
                ...
                String sHypotenuseresult = " "; // default message
        ...
        <script>
            ...
            function myRectangleValidator()
            {
                ...
                {
                    alert("At least one of the values contains letters.");
                    return false;
                }
            ...
            function myCirleValidator()
            {
                ...
                if (isNaN(radius))
                {
                    alert("The value entered contains a letter.");
                    return false;
                }
